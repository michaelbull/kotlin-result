...
sourceSets.create("benchmark").java {
...
benchmark {
    ...
    // specify via regex to run specific classes, e.g
    //configurations["main"].include("BindBenchmark|michaelbull.result.FlatMapBenchmark")
}
